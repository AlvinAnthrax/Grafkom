...
namespace GrafAsset3d
{
    ...
    internal class Window : GameWindow
    {
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            _object[0].render(0, _time);
            /*_object[1].render(1, _time);
            if (_object[2].getVerticesLength())
            {
                ...
                _object[3].load(Constants.path + "shader.vert", Constants.path + "shader.frag", Size_x, Size_y);
                _object[3].render(3, _time);
            }
            _object[2].render(2, _time);*/
            SwapBuffers();
        }
        ...
        protected override void OnMouseDown(MouseButtonEventArgs e)
        {
            ...
            if (e.Button == MouseButton.Left)
            {
                ...
                _object[2].updateMousePosition(_x, _y, 0);
            }
        }
    }
}
